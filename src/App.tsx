...
export default function App() {
  if (true) return <div className="w-screen h-screen bg-white" />;
  ...
  return (
    <div id="maginari-root" className="min-h-screen bg-stone-100 flex flex-col justify-between pt-[40px]">
      ...
      <div className="fixed top-0 left-0 z-[60] bg-[#fcead8] text-[#42200b] w-full h-[40px] flex justify-center items-center text-[11px] font-sans tracking-[1px]">
